...
export const TechnicalSkillsCard = () => (
  <div className="bg-zinc-800 p-6 rounded-lg shadow-lg w-full text-sm text-zinc-300 space-y-4">
    ...
    <ul className="space-y-4">
      ...
      <li className="flex items-start gap-2"><FaBug /> Provided technical support to staff and students.</li>
...
export const SoftSkillsCard = () => (
  <div className="bg-zinc-800 p-6 rounded-lg shadow-lg w-full text-sm text-zinc-300 space-y-4">
    ...
    <ul className="space-y-4">
      <li className="flex items-start gap-2"><FaComments /> Effective written and verbal communication.</li>
      ...
      <li className="flex items-start gap-2"><FaTasks /> Good decision making and problem-solving skills.</li>
      <li className="flex items-start gap-2"><FaTasks /> Lifelong learner.</li>
      <li className="flex items-start gap-2"><FaTasks /> Results-oriented and pays attention to details.</li>
