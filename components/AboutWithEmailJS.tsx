        ...
        >
          ...
          <div className="mt-2 md:mt-4 mb-2 md:mb-0">
            ...
            <button
              ...
              className="inline-block mt-auto px-6 py-3 bg-blue-600/20 text-white border border-zinc-700 text-sm rounded-md hover:bg-blue-900/20 transition inline-flex"
            >
              Download Resume
            </button>
          </div>
      ...
      {showForm && !sent && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <p className='text-sm text-center'>Download link to resume will be sent to email provided here.</p>
      ...
      {sent && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-md text-center max-w-md w-full">
            ...
            <p className="text-sm mb-4">A link to download resume has been sent to your email!</p>
            <button
              onClick={() => {
                setSent(false)
                setShowForm(false)
